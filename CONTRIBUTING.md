...
Report bugs at [`github.com/nfb2021/polychromae`][repo].
...
`polychromae` could always use more documentation, whether as part of the official docs, in docstrings, or even on the web in blog posts, articles, and such.

### Submit Feedback

The best way to send feedback is to file an issue at [`github.com/nfb2021/polychromae`][repo].
...
Ready to contribute? Here's how to set up `polychromae` for local development.

1. Fork the `polychromae` repo on GitHub.
2. Clone your fork locally:

   ```sh
   git clone git@github.com:nfb2021/polychromae.git
   ```
...
[repo]: https://github.com/nfb2021/polychromae/issues
